      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8 lg:px-8 lg:pt-8">
        <div className="p-5 sm:p-6">
          ...
          <div className="mt-5 flex justify-center gap-3 lg:justify-start">
            <a
              href="https://github.com/sch4ncr1c4"
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub"
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0a1122] transition duration-300 ease-out hover:bg-white/5 sm:h-12 sm:w-12 sm:rounded-2xl lg:hover:-translate-y-0.5"
            >
              <img
                src={githubIcon}
                alt="Icono de GitHub"
            ...
            <a
              href="https://www.instagram.com/cristian.schx"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/cristian-schinocca-0a1632404/"
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn"
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0a1122] transition duration-300 ease-out hover:bg-white/5 sm:h-12 sm:w-12 sm:rounded-2xl lg:hover:-translate-y-0.5"
            >
              <img
                ...
                width="32"
                height="32"
                className="block h-[22px] w-[22px] sm:h-[26px] sm:w-[26px]"
                loading="lazy"
              />
            </a>
          </div>
